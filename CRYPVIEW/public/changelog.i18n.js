...
const CHANGELOG_I18N = {
  ...
  en: {
    ...
    versionBadge: 'Current version: v4.0 — June 2025',
    ...
    footerCopy:  '© 2025 CrypView — Beta Capital Enterprise',
    footFaq:     'FAQ',
    footCookies: 'Cookies',
    footPrivacy: 'Privacy',
    footRisks:   'Risks',
  ...
  fr: {
    ...
    versionBadge: 'Version actuelle : v4.0 — Juin 2025',
  ...
  zh: {
    ...
    versionBadge: '当前版本：v4.0 — 2025年6月',
  ...
  ar: {
    ...
    versionBadge: 'الإصدار الحالي: v4.0 — يونيو 2025',
