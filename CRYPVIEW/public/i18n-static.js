...
(function () {
  ...
  const TRANSLATIONS = {
    ...
    fr: {
      ...
      footer: {
        copy:    '© 2025 CrypView — Beta Capital Enterprise',
        cookies: 'Cookies',
        terms:   'Conditions',
        risks:   'Risques',
      ...
      privacy: {
        ...
        meta:      'Dernière mise à jour : Juin 2025 · CrypView — Beta Capital Enterprise',
    ...
    en: {
      ...
      privacy: {
        ...
        meta:      'Last updated: June 2025 · CrypView — Beta Capital Enterprise',
    ...
    zh: {
      ...
      privacy: {
        pageTag:   '法律',
        title:     '隐私政策',
        meta:      '最后更新：2025年6月 · CrypView — Beta Capital Enterprise',
    ...
    ar: {
      ...
      privacy: {
        ...
        meta:      'آخر تحديث: يونيو 2025 · CrypView — Beta Capital Enterprise',
