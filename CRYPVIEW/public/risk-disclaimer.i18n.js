...
const RISK_DISCLAIMER_I18N = {
  ...
  en: {
    ...
    pageTag:  '⚠ Legal',
    h1:       'Risk Disclaimer',
    pageMeta: 'Last updated: June 2025 · CrypView — Beta Capital Enterprise',
  ...
  fr: {
    ...
    pageMeta: 'Dernière mise à jour : Juin 2025 · CrypView — Beta Capital Enterprise',
  ...
  zh: {
    ...
    pageTag:  '⚠ 法律',
    h1:       '风险提示',
    pageMeta: '最后更新：2025年6月 · CrypView — Beta Capital Enterprise',
  ...
  ar: {
    ...
    pageMeta: 'آخر تحديث: يونيو 2025 · CrypView — Beta Capital Enterprise',
