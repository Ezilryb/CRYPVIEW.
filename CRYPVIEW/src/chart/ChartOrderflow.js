...
//              Même correctif que ChartFootprint — wsPool.subscribe()
//              déduplique les connexions physiques WS pour les streams
//              identiques (même symbol@aggTrade sur plusieurs panels).
//
...
export class ChartOrderflow {
  ...
  // Si Footprint et Orderflow sont actifs sur le même symbole,
  // ils partagent le même stream physique → 1 WS au lieu de 2.
