...
export class MultiChartView {
  ...
  #buildSharedComponents() {
    ...
    alertManager.onAlertsChange = () => {
      ...
      this.#alertListModal?.refresh(); // AlertCenterModal
    };
  }
...
class MultiChartInstance {
  ...
  #wsTicker = null;
  #resizeObs = null;
  /** Cache des indicateurs pour alertes avancées (mis à jour sur clôture de bougie) */
  ...
  syncAlertPriceLines() {
    ...
    for (const alert of active) {
      ...
      // Cherche la première condition de prix absolu
