  ...
  <div class="modal-box modal-box--risk-calc">
    ...
    <div class="modal-tabs" role="tablist">
      <button class="ind-tab active" id="rc-tab-position"
              role="tab" aria-selected="true">📐 Taille de position</button>
      <button class="ind-tab" id="rc-tab-rr"
              role="tab" aria-selected="false">⚖ Risque / Récompense</button>
      <button class="ind-tab" id="rc-tab-liq"
              role="tab" aria-selected="false">⚡ Levier &amp; Liquidation</button>
    </div>
...
<!-- ── CSS dédié Risk Calculator (injecté une seule fois) ──── -->
<style>
  /* Taille de la boîte */
  .modal-box--risk-calc {
    width: 540px;
