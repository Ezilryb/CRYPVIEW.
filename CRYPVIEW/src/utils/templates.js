...
<div class="ctx-sub" id="sub-tools" role="menu" aria-label="${t('ctxMenu.tools')}">
  ...
  <div class="ctx-item" id="ctx-open-risk-calc" role="menuitem">
    <div style="width:14px;text-align:center;font-size:12px">🧮</div>
    <div style="width:8px"></div>Calculatrice de risque
  </div>
  <div class="ctx-sep" role="separator"></div>
...
<div id="risk-calc-overlay"
     class="modal-overlay"
     style="align-items:center;justify-content:center;"
     role="dialog" aria-modal="true" aria-label="Calculatrice de risque">
  <div class="modal-box modal-box--risk-calc">

    <!-- Header -->
    <div class="modal-header">
      <div style="display:flex;align-items:center;gap:10px;">
        <div class="modal-title">🧮 Outils de Risque</div>
        <span style="font-size:9px;padding:2px 8px;border-radius:3px;
                     background:rgba(0,200,255,.12);color:#00c8ff;
                     border:1px solid rgba(0,200,255,.3);letter-spacing:.5px;">CALCULATRICE</span>
      </div>
      <button id="risk-calc-close" class="modal-close" aria-label="Fermer">✕</button>
    </div>

    <!-- Tabs — 6 onglets -->
    <div class="modal-tabs rc-tabs-scroll" role="tablist" aria-label="Outils de risque">
      <button class="ind-tab active" id="rc-tab-position"
              role="tab" aria-selected="true">📐 Position</button>
      <button class="ind-tab" id="rc-tab-rr"
              role="tab" aria-selected="false">⚖ R/R</button>
      <button class="ind-tab" id="rc-tab-liq"
              role="tab" aria-selected="false">⚡ Levier</button>
      <button class="ind-tab" id="rc-tab-maxloss"
              role="tab" aria-selected="false">📉 Perte max</button>
      <button class="ind-tab" id="rc-tab-trailing"
              role="tab" aria-selected="false">🎯 Stop suiveur</button>
      <button class="ind-tab" id="rc-tab-slippage"
              role="tab" aria-selected="false">💸 Frais/Slip.</button>
    </div>
