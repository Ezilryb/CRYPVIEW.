...
//
//  v3.2.1 :
//    - Paper Trading, Backtesting, Export & Partage, Paramètres
//      regroupés dans un sous-panneau "Outils" (#sub-tools / #cat-tools)
// ============================================================
...
<div id="profile-modal-overlay"
  ...
  <div class="modal-box modal-box--profiles">
    ...
    <div class="modal-tabs" role="tablist">
      <button class="ind-tab active" id="profile-tab-presets" role="tab" aria-selected="true">⚡ Presets</button>
...
<nav id="ctx-menu" role="menu" aria-label="Menu du graphique">
  ...
  <!-- Outils (nouveau sous-volet) -->
  <div class="ctx-cat" id="cat-tools" role="menuitem" aria-haspopup="true">
    <div class="ctx-cat-left"><span class="ctx-cat-icon" aria-hidden="true">🛠</span> Outils</div>
    <span class="ctx-cat-arrow" aria-hidden="true">▶</span>
  </div>
</nav>
...
<div class="ctx-sub" id="sub-multi" role="menu" aria-label="Vues multi-graphiques">
  ...
  <div class="ctx-sep" role="separator"></div>
  <div class="ctx-sub-title" style="font-size:8px;padding:4px 14px 2px;color:#5a6a80;">Côte à côte</div>
  ...
  <div class="ctx-item" id="ctx-multi4" role="menuitem">
    <div style="width:14px"></div>
    <div class="ctx-color-dot" style="background:#ff6eb4"></div>🔲 4 Charts (2×2)
  </div>
  <div class="ctx-item" id="ctx-multi9" role="menuitem">
    <div style="width:14px"></div>
    <div class="ctx-color-dot" style="background:#e040fb"></div>⊞ 9 Charts (3×3)
  </div>
  <div class="ctx-sep" role="separator"></div>
  <div class="ctx-sub-title" style="font-size:8px;padding:4px 14px 2px;color:#5a6a80;">Verticaux</div>
  <div class="ctx-item" id="ctx-multiv2" role="menuitem">
    <div style="width:14px"></div>
    <div class="ctx-color-dot" style="background:#00c8ff"></div>↕ 2 Verticaux
  </div>
  <div class="ctx-item" id="ctx-multiv3" role="menuitem">
    <div style="width:14px"></div>
    <div class="ctx-color-dot" style="background:#ff9900"></div>↕ 3 Verticaux
  </div>
  <div class="ctx-sep" role="separator"></div>
  <div class="ctx-sub-title" style="font-size:8px;padding:4px 14px 2px;color:#5a6a80;">Asymétriques</div>
  <div class="ctx-item" id="ctx-multi1p2" role="menuitem">
    <div style="width:14px"></div>
    <div class="ctx-color-dot" style="background:#f7c948"></div>⬛ 1 + 2
  </div>
  <div class="ctx-item" id="ctx-multi1p3" role="menuitem">
    <div style="width:14px"></div>
    <div class="ctx-color-dot" style="background:#00e5cc"></div>⬛ 1 + 3
  </div>
</div>
...
<div class="ctx-sub" id="sub-draw" role="menu" aria-label="Outils de dessin">
  ...
  <div class="ctx-item" data-tool="arrow"   role="menuitem"><div class="ctx-check"></div><span>➡️</span> Flèche</div>
  <div class="ctx-item" data-tool="text"    role="menuitem"><div class="ctx-check"></div><span>📝</span> Texte annoté</div>
  <div class="ctx-item" data-tool="measure" role="menuitem"><div class="ctx-check"></div><span>📐</span> Mesure / Range</div>
  <div class="ctx-item" data-tool="channel" role="menuitem"><div class="ctx-check"></div><span>▰</span>  Canal parallèle</div>
  <div class="ctx-sep" role="separator"></div>
...
<!-- ── Sous-panneau : Outils (NEW) ───────────────────────── -->
<div class="ctx-sub" id="sub-tools" role="menu" aria-label="Outils avancés">
  <div class="ctx-sub-title">🛠 Outils avancés</div>
  <div class="ctx-item" id="ctx-open-paper-trading" role="menuitem">
    <div style="width:14px;text-align:center;font-size:12px">📈</div>
    <div style="width:8px"></div>Paper Trading
  </div>
  <div class="ctx-item" id="ctx-open-backtest" role="menuitem">
    <div style="width:14px;text-align:center;font-size:12px">🧪</div>
    <div style="width:8px"></div>Backtesting
  </div>
  <div class="ctx-sep" role="separator"></div>
  <div class="ctx-item" id="ctx-open-export" role="menuitem">
    <div style="width:14px;text-align:center;font-size:12px">📤</div>
    <div style="width:8px"></div>Export &amp; Partage
  </div>
  <div class="ctx-sep" role="separator"></div>
  <div class="ctx-item" id="ctx-open-settings" role="menuitem">
    <div style="width:14px;text-align:center;font-size:12px">⚙️</div>
    <div style="width:8px"></div>Paramètres
  </div>
</div>
        ...
        <div id="alert-builder-behavior"
          ...
          <div style="display:flex;flex-direction:column;gap:9px;">
            <div class="ab-behavior-row">
              <label>
                <input type="checkbox" id="ab-repeat" class="ab-toggle" aria-label="Répéter l'alerte">
            ...
            <div class="ab-behavior-row" id="ab-cooldown-row" style="display:none;">
              ...
              <select id="ab-cooldown" class="ab-field" style="width:auto;padding:4px 8px;font-size:10px;" aria-label="Durée de cooldown">
            ...
            <div class="ab-behavior-row" id="ab-maxtrig-row" style="display:none;">
              ...
              <select id="ab-max-triggers" class="ab-field" style="width:auto;padding:4px 8px;font-size:10px;" aria-label="Nombre maximum de déclenchements">
            ...
            <div class="ab-behavior-row">
              ...
              <select id="ab-expiration" class="ab-field" style="width:auto;padding:4px 8px;font-size:10px;" aria-label="Durée avant expiration">
...
<div id="alert-center-overlay"
  ...
  <div id="alert-center-modal" class="modal-box modal-box--alert-center">
    <div class="modal-header">
      <div style="display:flex;align-items:center;gap:10px;">
        <div class="modal-title">🔔 ${t('alerts.center')}</div>
    ...
    <div class="modal-tabs" role="tablist">
      <button class="ind-tab active" id="alert-center-tab-active" role="tab" aria-selected="true" data-tab="active">Actives</button>
      <button class="ind-tab" id="alert-center-tab-history" role="tab" aria-selected="false" data-tab="history">Historique</button>
    </div>
    ...
    <div class="modal-footer">
      ...
      <button id="alert-center-action-btn" class="modal-btn-danger" style="display:none;" aria-label="Action sur les alertes"></button>
    </div>
  </div>
</div>
...
<div id="screener-overlay"
  ...
  <div class="modal-box modal-box--screener">
    ...
    <div class="scr-toolbar">
      <input id="screener-search" type="text" placeholder="Filtrer par nom (ex: BTC, ETH…)"
             autocomplete="off" spellcheck="false" aria-label="Recherche de paire">
      <div class="scr-meta">
...
<div id="export-modal-overlay"
  ...
  <div class="modal-box modal-box--export">
    ...
    <div class="modal-tabs" role="tablist">
      <button class="ind-tab active" id="export-tab-image" role="tab" aria-selected="true">📷 Image</button>
      <button class="ind-tab" id="export-tab-data" role="tab" aria-selected="false">📊 Données</button>
      <button class="ind-tab" id="export-tab-share" role="tab" aria-selected="false">🔗 Partage</button>
    </div>
